        ...
        <div class="container-fluid">
          ...
          <div class="row mt-3 pl-5">
            <div className={classes.boxes}>
              <p> Search files by filtering from stored metadata in an easy-to-use and interactive way. </p>
              <a href="/Search" exact className={classes.linkStyle}> Go to Search section </a>
            </div>
          </div>
