...
var Tabs = function (_Component) {
  ...
  function Tabs() {
    ...
    }, _this.disabledTabIndexes = new Set(), _this.id = _this.props.id || 'tabs-' + (0, _utils.generateId)(), _this.vertical = _this.props.position === 'start' || _this.props.position === 'end', _this.getPanelId = function (index) {
  ...
  _createClass(Tabs, [{
    ...
    value: function render() {
      ...
      _react.Children.forEach(children, function (tab, index) {
        ...
        tabItems.push((0, _react.cloneElement)(tab, tabProps));
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_TabPanel2.default, tabPanelProps)
      );
    }
  }]);
...
Tabs.propTypes = process.env.NODE_ENV !== "production" ? {
   ...
   */
  defaultSelectedTabIndex: _propTypes2.default.number,
  ...
  maxTabWidth: _propTypes2.default.oneOfType([_propTypes2.default.number, _propTypes2.default.string]),

  /** Called when a Tab is selected */
  onChange: _propTypes2.default.func,

  /** Position of the tab list in relation to the tab panel */
  position: _propTypes2.default.oneOf(['bottom', 'end', 'start', 'top']),
   ...
   */
  selectedTabIndex: _propTypes2.default.number,

  /** @Private Theme */
  theme: _propTypes2.default.object.isRequired
} : {};
exports.default = (0, _themes.withTheme)(Tabs);