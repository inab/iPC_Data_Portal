...
var styles = {
  ...
  inner: function inner(_ref2) {
    ...
    var theme = _extends({}, componentTheme(baseTheme), tabPanelComponentTheme(baseTheme));
  ...
  root: function root(_ref4) {
    ...
    }, vertical && height ? _defineProperty({}, onlyIEAndEdge, {
      height: height
    }) : undefined);
  }
};

var ThemedButton = createThemedComponent(Button, function (_ref6) {
...
var ThemedOverflowContainerWithShadows = createThemedComponent(OverflowContainerWithShadows, function (_ref7) {
...
var ArrowButton = createStyledComponent(ThemedButton, styles.button, {
  displayName: 'ArrowButton'
});
var Inner = createStyledComponent(ThemedOverflowContainerWithShadows, styles.inner, {
  displayName: 'Inner',
  withProps: {
    hideScrollbars: true,
...
var List = createStyledComponent('ul', styles.list);
...
var IncrementButton = function IncrementButton(_ref8) {
  ...
  return React.createElement(ArrowButton, _extends({
    'aria-hidden': true,
    iconStart: icon,
    minimal: true,
    size: 'medium',
...
var _ref10 = _jsx(IconExpandLess, {});

var _ref11 = _jsx(IconChevronLeft, {});

var _ref12 = _jsx(IconExpandMore, {});

var _ref13 = _jsx(IconChevronRight, {});
...
var TabList = function (_Component) {
  ...
  function TabList() {
    ...
    }, _this.handleWindowResize = debounce(_this.updateScrollable, 100), _temp), _possibleConstructorReturn(_this, _ret);
  }
...
TabList.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  position: PropTypes.oneOf(['bottom', 'start', 'end', 'top']),
